...
export const skillsRowOne: Skill[] = [
  ...
  { name: 'C++',          icon: 'ri-code-line',          color: '#00599C' },
...
export const skillsRowTwo: Skill[] = [
  { name: 'Shopify (Liquid)', icon: 'ri-shopping-bag-3-fill', color: '#95BF47' },
  { name: 'WordPress',        icon: 'ri-wordpress-line',      color: '#21759B' },
  { name: 'WooCommerce',      icon: 'ri-shopping-cart-line',  color: '#96588a' },
  { name: 'Wix',              icon: 'ri-window-line',         color: '#7b7b7b' },
  ...
  { name: 'RESTful APIs',     icon: 'ri-api-line',            color: '#62a92b' },
