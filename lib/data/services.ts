...
export const services: Service[] = [
  {
    ...
    description:
      "Crafting visually appealing and user-friendly interfaces using HTML, CSS, JavaScript, and modern frameworks like React and Next.js.",
    ...
    highlights: ["HTML", "CSS", "JavaScript", "React", "Next.js"],
  },
  {
    id: "database-management",
    title: "Database Management",
    description:
      "Designing and managing NoSQL databases using MongoDB. Ensuring optimised performance, security, and scalability for web applications.",
    iconViewBox: "0 0 24 24",
    iconPath:
    ...
    highlights: ["NoSQL", "MongoDB"],
  },
  {
    id: "api-development",
    title: "API Development",
    description:
      "Developing and integrating RESTful APIs to enable seamless communication between front-end and back-end systems. Expertise in Node.js and Express.js.",
    iconViewBox: "0 0 24 24",
    iconPath:
    ...
    highlights: ["RESTful APIs", "Node.js", "Express.js"],
  },
  {
    id: "performance-optimisation",
    title: "Performance Optimisation",
    description:
      "Enhancing website and application speed for a smooth user experience. Implementing caching, lazy loading, and database indexing. Optimising WordPress websites for speed and SEO using LiteSpeed and WP Rocket.",
    iconViewBox: "0 0 24 24",
    iconPath:
    ...
    highlights: ["caching", "lazy loading", "database indexing", "WordPress", "LiteSpeed", "WP Rocket"],
  },
  {
    id: "ecommerce",
    title: "E-commerce Solutions",
    description:
      "Building scalable and secure e-commerce platforms using WooCommerce, Shopify, and custom MERN stack solutions. Integrating payment gateways, inventory management, and user-friendly shopping experiences.",
    iconViewBox: "0 0 24 24",
    iconPath:
